...
# Example: ./runById mysql_192.168.100.14_crm_polly 12

set -euo pipefail

# Predefined list of datasources and IDs
DATASOURCES=("mysql_192.168.100.14_crm_liher" "mysql_192.168.100.14_crm_polly" "mysql_192.168.100.14_crm_john" "mysql_192.168.100.14_crm_jason")
