...
# Example: ./runById mysql_192.168.100.15_crm_polly 12

set -euo pipefail

# Predefined list of datasources and IDs
DATASOURCES=("mysql_192.168.100.15_crm_liher" "mysql_192.168.100.15_crm_polly" "mysql_192.168.100.15_crm_john" "mysql_192.168.100.15_crm_jason")
...
###############################################################################
{
  ...
  curl --silent --show-error --location --request POST \
       'http://192.168.100.15:80/api/runDatabaseQueryByDatasourceMapAndQueryId' \
