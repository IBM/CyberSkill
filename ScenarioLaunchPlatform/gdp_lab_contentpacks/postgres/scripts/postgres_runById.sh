...
# Example: ./runById postgres_192.168.100.12_crm_polly 301

set -euo pipefail

# Predefined list of datasources and IDs
DATASOURCES=("postgres_192.168.100.12_crm_liher" "postgres_192.168.100.12_crm_polly" "postgres_192.168.100.12_crm_john" "postgres_192.168.100.12_crm_jason")
IDS=("301" "302" "303" "304" "305" "306" "307" "308" "309" "310" "311" "312" "313" "314" "315" "316" "317" "318" "319" "320" "321" "322" "323" "324" "325" "326")
...
} | tee -a /var/log/slp_postgres_run_query.log
