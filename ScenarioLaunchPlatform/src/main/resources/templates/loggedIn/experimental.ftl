        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Experimental</h6>
              <!-- -->
             	<img name="liher4" src="w3images/liher4.png" width="970" height="610" id="liher4" usemap="#m_liher4" alt="" />
      		...
      		<!-- -->
				<div id="experimentalFeatureModal" class="w3-modal">
				    <div class="w3-modal-content">
				      <div class="w3-container">
				        <span onclick="document.getElementById('experimentalFeatureModal').style.display='none'" class="w3-button w3-display-topright">&times;</span>
				        <p id="experimentalFeature">
...
function showImage(imageRef)
{
 	...
 	if(imageRef === '1_1')
 	{
 		...
 		var image = 'w3images/slide2.png';
 		document.getElementById('experimentalFeature').innerHTML = "<img name='liher' src='"+image+"' width='800' height='550' id='holdImage' alt='' />";	
 		document.getElementById('experimentalFeatureModal').style.display='block';
 	}
 	if(imageRef === '1_2')
 	{
 		console.log("match: " + imageRef);
 	...
 	{
 		console.log("match: " + imageRef);
 		var image = 'w3images/slide12.png';
 		document.getElementById('experimentalFeature').innerHTML = "<img name='liher' src='"+image+"' width='800' height='550' id='holdImage' alt='' />";	
 		document.getElementById('experimentalFeatureModal').style.display='block';
 	}
 	if(imageRef === '5_4')
 	...
 	{
 		console.log("match: " + imageRef);
 		var image = 'w3images/slide10.png';
 		document.getElementById('experimentalFeature').innerHTML = "<img name='liher' src='"+image+"' width='800' height='550' id='holdImage' alt='' />";	
 		document.getElementById('experimentalFeatureModal').style.display='block';
 	}
 	if(imageRef === '5_7')
 	{
 		console.log("match: " + imageRef);
 		var image = 'w3images/slide11.png';
 		document.getElementById('experimentalFeature').innerHTML = "<img name='liher' src='"+image+"' width='800' height='550' id='holdImage' alt='' />";	
 		document.getElementById('experimentalFeatureModal').style.display='block';
 	}
 	if(imageRef === '5_8')
 	...
 	{
 		console.log("match: " + imageRef);
 		var image = 'w3images/slide14.png';
 		document.getElementById('experimentalFeature').innerHTML = "<img name='liher' src='"+image+"' width='800' height='550' id='holdImage' alt='' />";	
 		document.getElementById('experimentalFeatureModal').style.display='block';
 	}
 	if(imageRef === '6_2')
 	{
 		console.log("match: " + imageRef);
 		var image = 'w3images/slide18.png';
 		document.getElementById('experimentalFeature').innerHTML = "<img name='liher' src='"+image+"' width='800' height='550' id='holdImage' alt='' />";	
 		document.getElementById('experimentalFeatureModal').style.display='block';
 	}
 	if(imageRef === '6_3')
 	{
 		console.log("match: " + imageRef);
 		var image = 'w3images/slide21.png';
 		document.getElementById('experimentalFeature').innerHTML = "<img name='liher' src='"+image+"' width='800' height='550' id='holdImage' alt='' />";	
 		document.getElementById('experimentalFeatureModal').style.display='block';
 	}
 	if(imageRef === '6_4')
 	{
 		console.log("match: " + imageRef);
 		var image = 'w3images/slide20.png';
 		document.getElementById('experimentalFeature').innerHTML = "<img name='liher' src='"+image+"' width='800' height='550' id='holdImage' alt='' />";	
 		document.getElementById('experimentalFeatureModal').style.display='block';
 	}
 	if(imageRef === '6_4')
 	{
 		console.log("match: " + imageRef);
 		var image = 'w3images/slide22.png';
 		document.getElementById('experimentalFeature').innerHTML = "<img name='liher' src='"+image+"' width='800' height='550' id='holdImage' alt='' />";	
 		document.getElementById('experimentalFeatureModal').style.display='block';
 	}
 	if(imageRef === '7_1')
