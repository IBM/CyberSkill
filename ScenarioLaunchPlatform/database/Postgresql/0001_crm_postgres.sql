...
BEGIN
    ...
    CREATE ROLE john WITH LOGIN PASSWORD 'Password1!';
	...
	ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT EXECUTE ON FUNCTIONS TO john;
	ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT,INSERT,UPDATE ON TABLES TO john;
	ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT EXECUTE ON FUNCTIONS TO john;
    END IF;
    ...
    CREATE ROLE jason WITH LOGIN PASSWORD 'Password1!';
    GRANT SELECT ON ALL TABLES IN SCHEMA public TO jason;
	GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA public TO jason;
	ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT ON TABLES TO jason;
	ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT EXECUTE ON FUNCTIONS TO jason;
	ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT,INSERT,UPDATE ON TABLES TO jason;
	ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT EXECUTE ON FUNCTIONS TO jason;
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'polly') THEN
        CREATE ROLE polly WITH LOGIN SUPERUSER PASSWORD 'Password1!';
    END IF;
    ...
    CREATE ROLE liher WITH LOGIN SUPERUSER PASSWORD 'Password1!';
    END IF;
