...
-- CREATE USER IF NOT EXISTS 'POLLY'@'%' IDENTIFIED BY 'password';
-- CREATE USER IF NOT EXISTS 'JOHN'@'%' IDENTIFIED BY 'password';
-- CREATE USER IF NOT EXISTS 'JASON'@'%' IDENTIFIED BY 'password';
-- CREATE USER IF NOT EXISTS 'LIHER'@'%' IDENTIFIED BY 'password';
