...
CREATE USER IF NOT EXISTS 'POLLY'@'%' IDENTIFIED BY 'ChangeMe!1';
CREATE USER IF NOT EXISTS 'JOHN'@'%' IDENTIFIED BY 'ChangeMe!1';
CREATE USER IF NOT EXISTS 'JASON'@'%' IDENTIFIED BY 'ChangeMe!1';
CREATE USER IF NOT EXISTS 'LIHER'@'%' IDENTIFIED BY 'ChangeMe!1';
