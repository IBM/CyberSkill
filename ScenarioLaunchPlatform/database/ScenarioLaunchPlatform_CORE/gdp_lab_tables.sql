...
INSERT INTO public.tb_databaseconnections (id, db_connection_id, status, db_type, db_version, db_username, db_password, db_port, db_database, db_url, db_jdbcclassname, db_usericon, db_databaseicon, db_alias, db_access) VALUES (4, 'postgresql_192.168.100.12_crm_john', 'active', 'postgresql', '14', 'john', 'Password1!', '5432', 'crm', '192.168.100.12', 'org.postgresql.Driver', '', '', 'Standard User', 'Select,Update,Insert,Delete,Usage');
INSERT INTO public.tb_databaseconnections (id, db_connection_id, status, db_type, db_version, db_username, db_password, db_port, db_database, db_url, db_jdbcclassname, db_usericon, db_databaseicon, db_alias, db_access) VALUES (3, 'postgresql_192.168.100.12_crm_jason', 'active', 'postgresql', '14', 'jason', 'Password1!', '5432', 'crm', '192.168.100.12', 'org.postgresql.Driver', '', '', 'Standard User', 'Select,Update,Insert,Delete,Usage');
INSERT INTO public.tb_databaseconnections (id, db_connection_id, status, db_type, db_version, db_username, db_password, db_port, db_database, db_url, db_jdbcclassname, db_usericon, db_databaseicon, db_alias, db_access) VALUES (2, 'postgresql_192.168.100.12_crm_liher', 'active', 'postgresql', '14', 'liher', 'Password1!', '5432', 'crm', '192.168.100.12', 'org.postgresql.Driver', '', '', 'Badguy', 'Superuser');
INSERT INTO public.tb_databaseconnections (id, db_connection_id, status, db_type, db_version, db_username, db_password, db_port, db_database, db_url, db_jdbcclassname, db_usericon, db_databaseicon, db_alias, db_access) VALUES (1, 'postgresql_192.168.100.12_crm_polly', 'active', 'postgresql', '14', 'polly', 'Password1!', '5432', 'crm', '192.168.100.12', 'org.postgresql.Driver', '', '', 'DB Admin', 'Superuser');
INSERT INTO public.tb_databaseconnections (id, db_connection_id, status, db_type, db_version, db_username, db_password, db_port, db_database, db_url, db_jdbcclassname, db_usericon, db_databaseicon, db_alias, db_access) VALUES (8, 'mysql_192.168.100.13_crm_john', 'active', 'mysql', '10', 'john', 'Password1!', '3306', 'crm', '192.168.100.13', 'com.mysql.cj.jdbc.Driver', '', '', 'Standard User', 'Select,Update,Insert,Delete,Execute');
INSERT INTO public.tb_databaseconnections (id, db_connection_id, status, db_type, db_version, db_username, db_password, db_port, db_database, db_url, db_jdbcclassname, db_usericon, db_databaseicon, db_alias, db_access) VALUES (7, 'mysql_192.168.100.13_crm_jason', 'active', 'mysql', '10', 'jason', 'Password1!', '3306', 'crm', '192.168.100.13', 'com.mysql.cj.jdbc.Driver', '', '', 'Standard User', 'Select,Update,Insert,Delete,Execute');
INSERT INTO public.tb_databaseconnections (id, db_connection_id, status, db_type, db_version, db_username, db_password, db_port, db_database, db_url, db_jdbcclassname, db_usericon, db_databaseicon, db_alias, db_access) VALUES (5, 'mysql_192.168.100.13_crm_polly', 'active', 'mysql', '10', 'polly', 'Password1!', '3306', 'crm', '192.168.100.13', 'com.mysql.cj.jdbc.Driver', '', '', 'DB Admin', 'All Privileges');
INSERT INTO public.tb_databaseconnections (id, db_connection_id, status, db_type, db_version, db_username, db_password, db_port, db_database, db_url, db_jdbcclassname, db_usericon, db_databaseicon, db_alias, db_access) VALUES (6, 'mysql_192.168.100.13_crm_liher', 'active', 'mysql', '10', 'liher', 'Password1!', '3306', 'crm', '192.168.100.13', 'com.mysql.cj.jdbc.Driver', '', '', 'Badguy', 'All Privileges');
