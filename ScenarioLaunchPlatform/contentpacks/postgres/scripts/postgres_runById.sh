...
# Example: ./runById postgres_127.0.0.1_crm_polly 301

set -euo pipefail

# Predefined list of datasources and IDs
DATASOURCES=("postgres_127.0.0.1_crm_liher" "postgres_127.0.0.1_crm_polly" "postgres_127.0.0.1_crm_john" "postgres_127.0.0.1_crm_jason")
