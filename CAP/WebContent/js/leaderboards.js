...
function loadLeaderBoardsData() {
	...
	Chart_AJAX.getTopPlayerScores();
	Chart_AJAX.getSimilarPlayerScores();
}
...
var Chart_AJAX = {
		...
		//********* GETs ************
		getTopPlayerScores: function() {

			function createRequest() {
				var xmlhttp = new XMLHttpRequest();		
				xmlhttp.onreadystatechange = callback;
				xmlhttp.open("GET", "moduleFeed?operation=getTopPlayerScores", true);
				xmlhttp.send(null);
		...
		//********* GETs ************
		getSimilarPlayerScores: function() {

			function createRequest() {
				var xmlhttp = new XMLHttpRequest();		
				xmlhttp.onreadystatechange = callback;
				xmlhttp.open("GET", "moduleFeed?operation=getSimilarPlayerScores", true);
				xmlhttp.send(null);
