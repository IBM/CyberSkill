...
if(SessionValidator.validate(ses))
{
	...
	if(levelOpen)
	{
		...
		if(answer != null)
		{
			if(answer.compareToIgnoreCase("51") == 0)
			{
				answerCorrect = true;
			}
		}
		  ...
		  <div class="w3-half w3-blue-grey w3-container" style="height:700px">
		    <div class="w3-padding-64 w3-center">
		      ...
		      <div class="w3-left-align w3-padding-large">
		        ...
		        {
		       	%>
			        <p>Sometimes security is about seeing patterns where there are seemingly none, and knowing when to ejector seat out of the rabbit hole</p>
			        
			        
			        <p>
			        	<form action="#" method="get">
							<!-- Here is where we ask the question, change nothing only the question. -->
							102 - AREA(37.2431:115.7930)= ?
