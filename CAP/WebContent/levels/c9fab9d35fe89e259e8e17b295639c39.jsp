...
if(SessionValidator.validate(ses))
{
	...
	if(levelOpen)
	{
		...
		if(answer != null)
		{
			if(answer.compareToIgnoreCase("4f5a225d64131a2f") == 0)
			{
				answerCorrect = true;
			}
		}
	...
	%>			
	    ...
	    <div class="w3-modal-content w3-animate-top w3-card-4">
	      <header class="w3-container w3-cyan"> 
	       ...
	       <p>Read all about Steganograpy<form action="https://en.wikipedia.org/wiki/Steganography" target="_blank">
    <input type="submit" value="Steganography" />
</form> and Stego tools <form action="https://en.wikipedia.org/wiki/Steganography_tools" target="_blank">
    <input type="submit" value="Tools" /></form></p></p></div>
		  ...
		  <div class="w3-half w3-blue-grey w3-container" style="height:700px">
		    <div class="w3-padding-64 w3-center">
		      ...
		      <div class="w3-left-align w3-padding-large">
		        ...
		        {
		       	%>
			        <p>This is a stegonagraphy challenge. Steganography is the art of covered or hidden writing. The purpose of steganography is covert communication-to hide the existence of a message from a third party. To pass this challenge find the hidden message concealed within the image.</p>
