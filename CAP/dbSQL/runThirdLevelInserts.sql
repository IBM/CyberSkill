...
select submitUserSolution('test7@test.com','A XSS');
select submitUserSolution('test2@test.com','SQL Injection 1');
select submitUserSolution('test5@test.com','SQL Injection 1');
select submitUserSolution('test8@test.com','SQL Injection 1');
select submitUserSolution('test3@test.com','SQL Injection Quotation');
select submitUserSolution('test6@test.com','SQL Injection Quotation');
select submitUserSolution('test9@test.com','SQL Injection Quotation');
select submitUserSolution('test9@test.com','Verbose Error Message');
select submitUserSolution('test6@test.com','Verbose Error Message');
select submitUserSolution('test3@test.com','Verbose Error Message');